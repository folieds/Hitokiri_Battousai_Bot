...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "7045740764:AAH_ZTnekH8K373u-1TE_IDRsH01jWASIRU")
...
FORCE_SUB_CHANNEL_3 = int(os.environ.get("FORCE_SUB_CHANNEL_3", "-1002196754230"))
